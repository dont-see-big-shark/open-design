...
- Source project id: 284b9560-1b33-421f-a9f0-9a1d8e5ae64c
- Source project name: Web Prototype
- New design-system project id: 4fe3faba-d2e7-4f24-9033-ab7b39159cf1
...
```json
{
  ...
  "nameSource": "prompt",
  "linkedDirs": [
    "/Users/jadenjoe/develop/Caduceus"
  ]
}
```
